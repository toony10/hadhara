...
const navItems: NavItem[] = [
  ...
  { title: 'العلوم', subItems: ['الكتابه واللغه', 'الأدب', 'الرياضيات', 'الفلك', 'الطب والعلاج', 'فلسفة التعليم واهدافه'], link: '/education' },
]
          ...
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <ul className="hidden lg:flex space-x-8">
              { navItems.map((item, index) => (
                ...
                >
                  <Link href={ item.link }>
                    <button className="text-black hover:text-yellow-500 text-xl font-bold flex items-center space-x-2">
