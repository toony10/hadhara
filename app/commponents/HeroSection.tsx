...
const navItems: NavItem[] = [
    { title: 'الحياه اليوميه', subItems: ['الزراعه', 'العمل والحرف', 'الملابس والزينه', 'الترفيه'] },
    { title: 'العباده', subItems: ['الألهه', 'الأساطير', 'الأعياد الدينيه', 'المعابد والكهنه', 'التمائم والأختام', 'الكتب الدينيه'] },
